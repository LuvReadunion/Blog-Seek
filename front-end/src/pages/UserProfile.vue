<template>
  ...
  <div v-if="user !== null " >
      ...
      <!-- Blog Actions & List -->
      <div class = "followings-box" style="">
        <div style="margin-left:6%; font-size: 25px; font-weight: bold; 
            margin-bottom: 10px; white-space: nowrap; user-select:none;">我的收藏</div>
        <div v-if="true" >
          <a-col v-for= "item in followings" :key="item.id" margin-right="auto">
